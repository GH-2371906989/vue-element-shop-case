				...
				slideTo: function(e, t, a, i) {
					...
					if (r.updateProgress(g), l.normalizeSlideIndex)
						for (var y = 0; y < d.length; y += 1) {
							...
							void 0 !== d[y + 1] ? w >= b && w < E - (E - b) / 2 ? n = y : w >= b && w < E && (n = y + 1) : w >= b && (n =
								y)
						}
			...
			classes: {
				addClasses: function() {
					var e = this,
						...
						n = e.support,
						l = [];
					l.push("initialized"), l.push(a.direction), n.pointerEvents && !n.touch && l.push("pointer-events"), a.freeMode &&
						l.push("free-mode"), a.autoHeight && l.push("autoheight"), i && l.push("rtl"), a.slidesPerColumn > 1 && (l.push(
							"multirow"), "column" === a.slidesPerColumnFill && l.push("multirow-column")), r.android && l.push("android"),
						r.ios && l.push("ios"), a.cssMode && l.push("css-mode"), l.forEach((function(e) {
